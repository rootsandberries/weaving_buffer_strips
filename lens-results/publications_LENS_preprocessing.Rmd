...
#dim(record_df) #968 articles
#dim(record_df_data.authors.ids) #3453 authors
...
#table(is.na(record_df_data.authors.aff$country_code)) #885 missing country ID - may need to impute - try https://www.grid.ac/ Global Research Identifier Database (GRID) with name (affiliation name)
...
record_df_data.authors.aff[grep("UK", record_df_data.authors.aff$name), ]$country_code <- "UK"
record_df_data.authors.aff[grep("U.K.", record_df_data.authors.aff$name), ]$country_code <- "UK"
record_df_data.authors.aff[grep("U. K.", record_df_data.authors.aff$name), ]$country_code <- "UK"
record_df_data.authors.aff[grep("United Kingdom", record_df_data.authors.aff$name), ]$country_code <- "UK"
record_df_data.authors.aff[grep("Great Britain", record_df_data.authors.aff$name), ]$country_code <- "UK"
record_df_data.authors.aff[grep("Scotland", record_df_data.authors.aff$name), ]$country_code <- "UK"
...
record_df_data.authors.aff[grep("Switzerland", record_df_data.authors.aff$name), ]$country_code <- "SZ"
...
record_df_data.authors.aff[grep("Germany", record_df_data.authors.aff$name), ]$country_code <- "GM"
record_df_data.authors.aff[grep("Finland", record_df_data.authors.aff$name), ]$country_code <- "FI"
record_df_data.authors.aff[grep("Japan", record_df_data.authors.aff$name), ]$country_code <- "JA"
...
record_df_data.authors.aff[grep("Spain", record_df_data.authors.aff$name), ]$country_code <- "SP"
record_df_data.authors.aff[grep("China", record_df_data.authors.aff$name), ]$country_code <- "CH"
record_df_data.authors.aff[grep("Estonia", record_df_data.authors.aff$name), ]$country_code <- "EN"
record_df_data.authors.aff[grep("Norway", record_df_data.authors.aff$name), ]$country_code <- "NO"
record_df_data.authors.aff[grep("Sweden", record_df_data.authors.aff$name), ]$country_code <- "SW"
record_df_data.authors.aff[grep("Denmark", record_df_data.authors.aff$name), ]$country_code <- "DA"
record_df_data.authors.aff[grep("Austria", record_df_data.authors.aff$name), ]$country_code <- "AU"
...
record_df_data.authors.aff[grep("Australia", record_df_data.authors.aff$name), ]$country_code <- "AS"
record_df_data.authors.aff[grep("Taiwan", record_df_data.authors.aff$name), ]$country_code <- "TW"
record_df_data.authors.aff[grep("Slovakia", record_df_data.authors.aff$name), ]$country_code <- "LO"
...
record_df_data.authors.aff[grep("British", record_df_data.authors.aff$name), ]$country_code <- "UK"
record_df_data.authors.aff[grep("Devon", record_df_data.authors.aff$name), ]$country_code <- "UK"
record_df_data.authors.aff[grep("Norfolk", record_df_data.authors.aff$name), ]$country_code <- "UK"
record_df_data.authors.aff[grep("Chinese", record_df_data.authors.aff$name), ]$country_code <- "CH"
...
record_df_data.authors.aff[grep("Hobart", record_df_data.authors.aff$name), ]$country_code <- "AS"
record_df_data.authors.aff[grep("Monash", record_df_data.authors.aff$name), ]$country_code <- "AS"
record_df_data.authors.aff[grep("Scottish", record_df_data.authors.aff$name), ]$country_code <- "UK"
...
record_df_data.authors.aff[grep("Brno", record_df_data.authors.aff$name), ]$country_code <- "EZ"
record_df_data.authors.aff[grep("Padova", record_df_data.authors.aff$name), ]$country_code <- "IT"
record_df_data.authors.aff[grep("La Mancha", record_df_data.authors.aff$name), ]$country_code <- "SP"
...
record_df_data.authors.aff[grep("Edward Grey Institute of Field Ornithology", record_df_data.authors.aff$name), ]$country_code <- "UK"
record_df_data.authors.aff[grep("NERC", record_df_data.authors.aff$name), ]$country_code <- "UK"
record_df_data.authors.aff[grep("Technische", record_df_data.authors.aff$name), ]$country_code <- "GM"
...
record_df_data.authors.aff[grep("Hill & Mountain Research Centre", record_df_data.authors.aff$name), ]$country_code <- "UK"
...
record_df_data.authors.aff[grep("The Lodge", record_df_data.authors.aff$name), ]$country_code <- "UK"
record_df_data.authors.aff[grep("Science and Health", record_df_data.authors.aff$name), ]$country_code <- "AS"
record_df_data.authors.aff[grep("Plant and Ecological Sciences l", record_df_data.authors.aff$name), ]$country_code <- "NZ"
record_df_data.authors.aff[grep("Cooperative Research Centre", record_df_data.authors.aff$name), ]$country_code <- "AS"
...
##Note: only 75 left unresolved - too vague, unless going back to original papers to see whole affliation info
